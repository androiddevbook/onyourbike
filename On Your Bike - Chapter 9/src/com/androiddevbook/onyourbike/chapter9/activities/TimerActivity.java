...
import com.androiddevbook.onyourbike.chapter9.helpers.Camera;
...
public class TimerActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        application = ((OnYourBike) getApplication());
    ...
    class UpdateTimer implements Runnable {
        ...
        protected void vibrateCheck() {
            ((OnYourBike) getApplication()).vibrateCheck();
        }

        protected void notifyCheck() {
            String message = ((OnYourBike) getApplication()).notifyCheck();
